...
def extract_interesting_sections(interesting_sections):
    ...
    paths =["../../sante_veau/videos/2022-03-24-2022-03-29"]
    for path in paths: 
        for root, dirs, files in os.walk(path):
            for file in files:
                #append the file name to the list
...
interesting_sections =interesting_sections.loc[(interesting_sections["date"].isin( [datetime(2022, 3, 28)]))]#,datetime(2022, 3, 6), datetime(2022, 2, 20), datetime(2022, 2, 27), datetime(2022, 3,13) ]))]
