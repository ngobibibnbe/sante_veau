...
def illness_status() :
    def get_ill(file, sheet):
        ...
        df_ill.loc[(39.2<df_ill["Score_Temperature"]) & (df_ill["Score_Temperature"]<=39.5), "Score_Temperature" ]=1
        df_ill.loc[(39.5<df_ill["Score_Temperature"]) & (df_ill["Score_Temperature"]<=39.9), "Score_Temperature" ]=2
        ...
        df_ill["Healthy"]= (df_ill["Score_Temperature"]<2) & (df_ill["somme_signe"]==0) & (df_ill["Diarrhé"]!=True) & (df_ill["Pneumonie"]!=True)
        
        return df_ill[["Healthy","Diarrhé","Pneumonie","No ATQ","somme_valeur_signes","somme_signe","Score_Temperature","Tête","Yeux","Toux","Naseaux","Fèces"]]
